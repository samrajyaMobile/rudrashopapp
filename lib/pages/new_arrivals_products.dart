...
class NewArrivalsProducts extends StatefulWidget {
  const NewArrivalsProducts({Key? key}) : super(key: key);
...
class _NewArrivalsProductsState extends State<NewArrivalsProducts> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<NewArrivalsProductsModel>(context, listen: false).getNewArrivals(context);
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Consumer<NewArrivalsProductsModel>(builder: (context, mainProducts, _) {
          return WillPopScope(
            onWillPop: () async {
              ...
              children: [
                Expanded(
                  ...
                  itemBuilder: (context, int index) {
                    NewArrivalProductData? products = mainProducts.productsList[index];
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
