...
class AppFonts {
  ...
  static TextStyle mediumGray20 = TextStyle(color: AppColor.black3, fontFamily: "medium", fontSize: 20,decoration: TextDecoration.lineThrough);
  ...
  static TextStyle mediumMainRed20 = TextStyle(color: AppColor.red, fontFamily: "medium", fontSize: 20);
